...
#DEFINE DT_DOUBLE	'B'
#DEFINE C_FILEUSE_LOC	"Fichier en cours d'utilisation. Impossible de créer l'index." && "File in use. Could not create index."
#DEFINE C_BADPARMS_LOC	"La routine d'indexation a reçu un nombre de paramètres incorrect." && "Incorrect number of parameters passed to indexing routine."
#DEFINE C_EXCLUSIVE_LOC	"EXCLUSIVE"

******************************************************************************
* Used by SaveOutFile method
******************************************************************************
#DEFINE C_FILEUSE2_LOC		"Fichier en cours d'utilisation. Merci d'en choisir un autre." && "File is in use. Please select another."
...
#define NORUNTIME_LOC ;
	"Les assistants Visual FoxPro requièrent la version Standard ou Professionnelle." && "Microsoft Visual FoxPro Wizards require the Standard or Professional version."
