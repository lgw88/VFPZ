...
namespace VFPX.FoxProIntegration.FoxProLanguageService {
    ...
    internal static class FoxProConstants {
        public const string FoxProFileExtension = ".prg";
        public const string FoxProCodeDomProviderName = "FoxPro";
        ...
        public const string PLKProductName = "Visual Studio Integration of FoxPro Language Service";
