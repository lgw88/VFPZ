#define MyAppName      "GKK Tools - Visual Class Editor"
#define MyAppVersion   "3.0"
#define MyAppVerName   "GKK Tools 3.0 - Visual Class Editor"
...
#define MyFileName     "E:\My Work\FoxPro\Projects\GKKTools\Editors\GKKEditVCX.app"
#define MyOutputName   "GKKClassEditor"
...
Source: "E:\My Work\C_Source\Ultimate Grid\Control\ax_ug.ocx"; DestDir: {sys}; Flags: sharedfile regserver; Components: Required\ACX
...
Source: "E:\My Work\FoxPro\Projects\GKKTools\Setup\Support\gkkconvert.fll"; DestDir: {app}; Flags: overwritereadonly; Components: Required\PRG
...
Root: HKCU; Subkey: Software\GKK Industries\GKK Tools; ValueType: string; ValueName: GKKEditVCX; ValueData: {app}; Components: ; Flags: uninsdeletekeyifempty deletekey deletevalue uninsdeletevalue noerror
