#define MyAppName      "GKK Tools - Table Designer"
#define MyAppVersion   "1.0"
#define MyAppVerName   "GKK Tools 1.0 - Table Designer"
#define MyAppPublisher "Gregory A. Green"
#define MyAppCopyright "Copyright ©2014 Gregory A. Green"
#define MyDefGroupName "GKK Tools"
#define MyFileName     "E:\My Work\FoxPro\Projects\GKKTools\Editors\GKKTableDesigner.app"
#define MyOutputName   "GKKTableDesigner"
...
Root: HKCU; Subkey: Software\GKK Industries\GKK Tools; ValueType: string; ValueName: GKKTableDesigner; ValueData: {app}; Components: ; Flags: uninsdeletekeyifempty deletekey deletevalue uninsdeletevalue noerror
