...
#DEFINE CF_DIBV5               17     && BITMAPV5HEADER structure
#DEFINE CF_OWNERDISPLAY       128     && Owner-display format
#DEFINE CF_DSPTEXT            129     && Private Text format
#DEFINE CF_DSPBITMAP          130     && Private Bitmap format
#DEFINE CF_DSPMETAFILEPICT    131     && Private Metafile format
#DEFINE CF_DSPENHMETAFILE     142     && Private Enhanced Metafile format
#DEFINE CF_PRIVATEFIRST       512     && Private format first
#DEFINE CF_PRIVATELAST        767     && Private format last
#DEFINE CF_GDIOBJFIRST        768     && GDI object format first
#DEFINE CF_GDIOBJLAST        1023     && GDI object format last
...
#DEFINE OBJTYPE_MBRC        19    && Memberclass code reference
#DEFINE OBJTYPE_TMET        20    && Control object method
#DEFINE OBJTYPE_IMET        21    && Control object inherited method
