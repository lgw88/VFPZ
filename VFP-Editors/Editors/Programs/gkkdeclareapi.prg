...
*-*
FUNCTION apiPathRelativePathTo
	LPARAMETERS tcPath, tcFrom, tnFromAttrib, tcTo, tnToAttrib
	DECLARE INTEGER PathRelativePathTo IN shlwapi.dll AS apiPathRelativePathTo STRING @tcPath, STRING @tcFrom, INTEGER tnFromAttrib, STRING @tcTo, INTEGER tnToAttrib
	RETURN apiPathRelativePathTo(tcPath, @tcFrom, tnFromAttrib, @tcTo, tnToAttrib)
ENDFUNC
