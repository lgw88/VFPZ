...
FUNCTION apiSleep
	...
	RETURN apiSleep(tnTime)
ENDFUNC

*-***********************************************************************************************
*-*	Win32 Functions for Internet access testing
*-*
FUNCTION apiInternetOpen
	LPARAMETERS sAgent, lAccessType, sProxyName, sProxyBypass, lFlags
	DECLARE INTEGER InternetOpen IN wininet.DLL AS apiInternetOpen STRING sAgent, INTEGER lAccessType, STRING sProxyName, STRING sProxyBypass, INTEGER lFlags
	RETURN apiInternetOpen(sAgent, lAccessType, sProxyName, sProxyBypass, lFlags)
ENDFUNC

FUNCTION apiInternetCloseHandle
	LPARAMETERS hInst
	DECLARE SHORT InternetCloseHandle IN wininet.DLL AS apiInternetCloseHandle INTEGER hInst
	RETURN apiInternetCloseHandle(hInst)
ENDFUNC


FUNCTION apiInternetCheckConnection
	LPARAMETERS lpszUrl, dwFlags, dwReserved
	DECLARE INTEGER InternetCheckConnection IN wininet AS apiInternetCheckConnection STRING lpszUrl, INTEGER dwFlags, INTEGER dwReserved
	RETURN apiInternetCheckConnection(lpszUrl, dwFlags, dwReserved)
ENDFUNC
