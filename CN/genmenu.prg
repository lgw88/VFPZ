...
#DEFINE c_hdr_author_LOC    "×÷ÕßÐÕÃû"
#DEFINE c_hdr_company_LOC   "¹«Ë¾Ãû³Æ"
#DEFINE c_hdr_address_LOC   "µØÖ·"
#DEFINE c_hdr_city_LOC      "³ÇÊÐ"
#DEFINE c_hdr_state_LOC     "  "
#DEFINE c_hdr_zip_LOC       "Zip"
#DEFINE c_hdr_ctry_LOC      "¹ú¼Ò"
#DEFINE c_hdr_copyright_LOC Copyright (C)
#DEFINE c_hdr_descript_LOC  ËµÃ÷:
#DEFINE c_hdr_string_LOC    This PROGRAM was automatically generated BY GENMENU.
#DEFINE c_shortcutdef_LOC  "FoxShortcutMenu"

*
#DEFINE c_snip_setup_LOC    " ÉèÖÃ´úÂë"
#DEFINE c_snip_cleanup_LOC  " Çå³ý´úÂëºÍ¹ý³Ì"
#DEFINE c_snip_init_LOC     " ÕýÔÚ³õÊ¼»¯´úÂë"
#DEFINE c_snip_menu_LOC     " ²Ëµ¥¶¨Òå"
...
#DEFINE c_err_invnumparm_LOC     "´«µÝµ½Éú³ÉÆ÷µÄ²ÎÊýºÅÂëÎÞÐ§¡£"
#DEFINE c_err_badgendate_LOC     "Éú³ÉÆ÷ÈÕÆÚÊ§Ð§¡£"
#DEFINE c_err_badrechead_LOC     "È±ÉÙÍ·¼ÇÂ¼ÔÚ "
#DEFINE c_err_nocloseapp_LOC     "²»ÄÜ¹Ø±Õ¸ÃÓ¦ÓÃ³ÌÐòÎÄ¼þ¡£"
#DEFINE c_err_badmnxpre_LOC      "²Ëµ¥ "
#DEFINE c_err_badmnxpost_LOC     " ÊÇÎÞÐ§µÄ"
#DEFINE c_err_nofileopen_LOC     "²»ÄÜ´ò¿ªÎÄ¼þ "
#DEFINE c_err_badnegoval_LOC     "ÎÞÐ§µÄ×Ö¶ÎÐ­ÒéÖµ "
#DEFINE c_err_title_LOC          "Genmenu ´íÎó"
#DEFINE c_err_lineno_LOC         "ÐÐºÅ: "
#DEFINE c_err_presskey_LOC       "°´ÈÎºÎ¼üÇå³ý²¢ÍË³ö..."
#DEFINE c_err_noopenerr_LOC      ".ERR ²»ÄÜ±»´ò¿ª..."
#DEFINE c_err_toomanymemvars_LOC "Ì«¶à memvars - GENMENU ½«ÖÕÖ¹..."    && ERROR 22 [Rev: 4][ADD]
#DEFINE c_err_nobangallowed_LOC  "²Ëµ¥ÎÄ¼þÃû²»ÄÜº¬ÓÐ¸Ã×Ö·û " + [" ! "]   && ! in menu [Rev: 6][ADD]
*
#DEFINE c_msg_gencomplete_LOC    "Éú³ÉÍê³É"
#DEFINE c_msg_genmenudefs_LOC    "Éú³É²Ëµ¥¶¨Òå..."
#DEFINE c_msg_genpopdefs_LOC     "Éú³Éµ¯³öÊ½²Ëµ¥¶¨Òå..."
#DEFINE c_msg_genprocs_LOC       "Éú³É¹ý³Ì..."
#DEFINE c_msg_gensetup_LOC       "Éú³É²Ëµ¥ÉèÖÃ´úÂë..."
#DEFINE c_msg_gencleanup_LOC     "Éú³É²Ëµ¥Çå³ý´úÂë..."
#DEFINE c_msg_genstopped_LOC     "Éú³É¹ý³ÌÍ£Ö¹¡£"
#DEFINE c_msg_genmenucode_LOC    "Éú³É²Ëµ¥´úÂë..."
*
#DEFINE c_sdierrdisplay_loc		"[¸Ã²Ëµ¥Ö»¿É´Ó¶¥²ã±íµ¥ÖÐµ÷ÓÃ¡£"+;
								"È·±£±íµ¥µÄ ShowWindow ÊôÐÔ±»ÉèÖÃÎª 2¡£"+;
								"¸üÏêÏ¸µÄ×ÊÁÏ£¬ÇëÔÄ¶Á²Ëµ¥ MPR ÎÄ¼þµÄÍ·²¿ÕÂ½Ú¡£]"
*
...
DO CASE
   ...
   OTHERWISE
      @ 3,3 SAY REPLICATE(CHR(0xDB),m.nblocks)
ENDCASE
